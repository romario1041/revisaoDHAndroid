 ...
 */
public class Fragment_popular extends Fragment implements ClickListener {

    public static int PAGE = 1;
    //public static String API_KEY = "e9258c359e580c8d5bc18cdc835efdd0";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_fragment_popular, container, false);
        ...
        call.enqueue(new Callback<MovieResults>() {
            ...
            public void onResponse(Call<MovieResults> call, Response<MovieResults> response) {
                ...
                adapterCategory.setClickListener(Fragment_popular.this);
