 ...
 */
public class Fragment_top_rated extends Fragment implements ClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_fragment_top_rated, container, false);
        ...
        call.enqueue(new Callback<MovieResults>() {
            ...
            public void onResponse(Call<MovieResults> call, Response<MovieResults> response) {
                ...
                adapterCategory.setClickListener(Fragment_top_rated.this);
            ...
            public void onFailure(Call<MovieResults> call, Throwable t) {
                Log.i("Falha", t.getMessage().intern());
            }
        });
