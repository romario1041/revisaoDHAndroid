 ...
 */
public class Fragment_upcoming extends Fragment implements ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_fragment_upcoming, container, false);
        ...
        call.enqueue(new Callback<MovieResults>() {
            ...
            public void onResponse(Call<MovieResults> call, Response<MovieResults> response) {
                ...
                adapterCategory.setClickListener(Fragment_upcoming.this);
